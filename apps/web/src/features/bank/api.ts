...
export const bankApi = {
  ...
  getBankBalances: (filters?: BankFilters): Promise<BankBalancesResponse> =>
    api.get('/bank/balances', filters),

  // Get bank balance by ID
  getBankBalance: (id: string): Promise<BankBalance> => api.get(`/bank/balances/${id}`),
  ...
  // Delete bank balance
  deleteBankBalance: (id: string): Promise<void> => api.delete(`/bank/balances/${id}`),
