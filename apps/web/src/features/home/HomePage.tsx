        ...
        <div className="rounded-lg border border-border bg-card p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-lg sm:text-2xl font-bold text-foreground">€700,000</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-lg sm:text-2xl font-bold text-foreground">€725,000</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-lg sm:text-2xl font-bold text-foreground">€225,000</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-lg sm:text-2xl font-bold text-destructive">€250,000</p>
            </div>
          </div>
        </div>
      </div>
